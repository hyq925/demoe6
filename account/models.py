...
class Shop(models.Model):
    shop_id = models.IntegerField(verbose_name='ID',primary_key=True)
    name = models.CharField('名称',max_length=100)
    sub_title = models.CharField('标题',max_length=255)
    original_price = models.DecimalField('原价',max_digits=7, decimal_places=2)
    promote_price = models.DecimalField('现价',max_digits=7, decimal_places=2)
